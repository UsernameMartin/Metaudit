...
static const char qt_meta_stringdata_DataSaver[] = {
    "DataSaver\0\0saveData()\0"
};

const QMetaObject DataSaver::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DataSaver,
      qt_meta_data_DataSaver, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DataSaver::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataSaver))
        return static_cast<void*>(const_cast< DataSaver*>(this));
